...
int main(void)
{
    ...
    {
        printf("Hello World!\n");
        HAL_Delay(1000); // Delay for 1 second between messages
    }

    /* Main loop */
    while (1)
    {
        LED2_Toggle(); // Keep toggling the LED to show the program is running
        HAL_Delay(500); // 500ms delay for LED toggle
    }
